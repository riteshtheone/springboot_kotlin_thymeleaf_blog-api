...
//    fun createPost(@RequestBody postBean : PostBean, @PathVariable userId: Int, @PathVariable categoryId: Int) : ResponseEntity<Post> = ResponseEntity<Post>(this.postService.createPost(postBean, userId, categoryId), HttpStatus.CREATED)
//
////    // PUT -> update post
////    @PutMapping("/{postId}")
