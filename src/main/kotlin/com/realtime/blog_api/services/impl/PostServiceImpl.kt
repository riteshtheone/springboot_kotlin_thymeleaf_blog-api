...
class PostServiceImpl(
    ...
    override fun getAllPost(pageNumber: Int, pageSize: Int): List<PostBean> = this.postRepository.findAll(PageRequest.of(pageNumber, pageSize)).content.stream().map { post: Post -> this.modelMapper.map(post, PostBean::class.java) }.collect(Collectors.toList())
